...
**The estimated accuracy of the model is `r round(model_accuracy*100,1)`% and the estimated out-of-sample error based on our fitted model applied to the cross validation dataset is `r round(out_of_sample_error*100,1)`%.** 
